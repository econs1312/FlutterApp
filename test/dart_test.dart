...
int sumOfDigits(int number) {
  // Lançando o erro corretamente para fazer o teste 'throwsArgumentError' passar
  if (number < 0) {
    throw ArgumentError("Erro: O número deve ser positivo.");
  }
...
// Uma única função main para agrupar todos os testes
void main() {
